...
5. Add `META_APP_ID`, `META_APP_SECRET`, redirect URI, and Graph version to the server environment. Generate `TOKEN_ENCRYPTION_KEY` with 32 random bytes encoded as base64.
